...
The store holds **621** cards, of which **607** are executable and **14** are recorded but blocked. This document ranks what to build next by how much of that blocked knowledge each capability releases.
...
|---:|---|---|---|---:|---:|---:|
| 1 | `dep.triped-sign-class` — the 'triped' sign class | — | — | 1 | +1 | 608 |
| 2 | `dep.transit` — transit (gochara) calculation | — | — | 6 | +2 | 610 |
| 3 | `dep.second-nativity` — a second nativity | — | — | 5 | +1 | 611 |
| 4 | `dep.prashna` — prashna (horary) branch | — | — | 6 | +1 | 612 |
| 5 | `dep.adjudication` — Stage 7 adjudication | — | — | 8 | +1 | 613 |
| 6 | `dep.strength-ranking` — ordinal comparison of graha strength | `dep.shadbala-arithmetic` | — | 26 | +2 | 615 |
| 7 | `dep.universal-quantification` — universal quantification over a variable-membership set | — | — | 15 | +1 | 616 |
| 8 | `dep.varga-ownership` — varga ownership predicate | — | ch. 21 | 20 | +1 | 617 |
| 9 | `dep.manual-verification` — human verification of the encoding | — | — | 20 | +1 | 618 |
| 10 | `dep.body-part-significator` — house-to-body-part correspondence | — | — | 2 | +1 | 619 |
| 11 | `dep.ashtakavarga` — ashtakavarga | — | ch. 23 | 22 | +1 | 620 |

Completing this sequence costs **131 units** and moves executable cards from **607** to **620** — releasing **13 of the 14** currently blocked cards.
...
Across the 16 unencoded chapters that is roughly **670 cards**, of which about **0 (0%) would be inert on arrival** if they were encoded before the missing capabilities exist.
