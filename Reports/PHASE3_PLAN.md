...
The store holds **594** cards, of which **580** are executable and **14** are recorded but blocked. This document ranks what to build next by how much of that blocked knowledge each capability releases.
...
|---:|---|---|---|---:|---:|---:|
| 1 | `dep.triped-sign-class` — the 'triped' sign class | — | — | 1 | +1 | 581 |
| 2 | `dep.transit` — transit (gochara) calculation | — | — | 6 | +2 | 583 |
| 3 | `dep.second-nativity` — a second nativity | — | — | 5 | +1 | 584 |
| 4 | `dep.prashna` — prashna (horary) branch | — | — | 6 | +1 | 585 |
| 5 | `dep.adjudication` — Stage 7 adjudication | — | — | 8 | +1 | 586 |
| 6 | `dep.strength-ranking` — ordinal comparison of graha strength | `dep.shadbala-arithmetic` | — | 26 | +2 | 588 |
| 7 | `dep.universal-quantification` — universal quantification over a variable-membership set | — | — | 15 | +1 | 589 |
| 8 | `dep.manual-verification` — human verification of the encoding | — | — | 20 | +1 | 590 |
| 9 | `dep.body-part-significator` — house-to-body-part correspondence | — | — | 2 | +1 | 591 |
| 10 | `dep.varga-ownership` — varga ownership predicate | — | ch. 21 | 21 | +1 | 592 |
| 11 | `dep.ashtakavarga` — ashtakavarga | — | ch. 23 | 23 | +1 | 593 |

Completing this sequence costs **133 units** and moves executable cards from **580** to **593** — releasing **13 of the 14** currently blocked cards.
...
Across the 18 unencoded chapters that is roughly **775 cards**, of which about **0 (0%) would be inert on arrival** if they were encoded before the missing capabilities exist.
