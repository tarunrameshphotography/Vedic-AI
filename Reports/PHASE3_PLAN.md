...
The store holds **623** cards, of which **609** are executable and **14** are recorded but blocked. This document ranks what to build next by how much of that blocked knowledge each capability releases.
...
| 6 | `dep.adjudication` — Stage 7 adjudication | — | — | 8 | +1 | 616 |
| 7 | `dep.strength-ranking` — ordinal comparison of graha strength | `dep.shadbala-arithmetic` | — | 26 | +2 | 618 |
| 8 | `dep.universal-quantification` — universal quantification over a variable-membership set | — | — | 15 | +1 | 619 |
| 9 | `dep.varga-ownership` — varga ownership predicate | — | ch. 21 | 20 | +1 | 620 |
| 10 | `dep.manual-verification` — human verification of the encoding | — | — | 20 | +1 | 621 |
| 11 | `dep.body-part-significator` — house-to-body-part correspondence | — | — | 2 | +1 | 622 |
| 12 | `dep.ashtakavarga` — ashtakavarga | — | ch. 23 | 22 | +1 | 623 |

Completing this sequence costs **132 units** and moves executable cards from **609** to **623** — releasing **14 of the 14** currently blocked cards.
