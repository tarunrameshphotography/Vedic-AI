...
The store holds **501** cards, of which **484** are executable and **17** are recorded but blocked. This document ranks what to build next by how much of that blocked knowledge each capability releases.
...
| `dep.manual-verification` — human verification of the encoding | process | 2 | 8 | 1 | 1 | 20 | 0.05 |
...
|---:|---|---|---|---:|---:|---:|
| 1 | `dep.triped-sign-class` — the 'triped' sign class | — | — | 1 | +1 | 485 |
| 2 | `dep.vargottama` — vargottama extractor | `dep.varga` | ch. 03 | 14 | +3 | 488 |
| 3 | `dep.second-nativity` — a second nativity | — | — | 5 | +1 | 489 |
| 4 | `dep.transit` — transit (gochara) calculation | — | — | 6 | +1 | 490 |
| 5 | `dep.prashna` — prashna (horary) branch | — | — | 6 | +1 | 491 |
| 6 | `dep.dasa` — vimshottari dasa engine | — | ch. 19 | 16 | +2 | 493 |
| 7 | `dep.adjudication` — Stage 7 adjudication | — | — | 8 | +1 | 494 |
| 8 | `dep.strength-ranking` — ordinal comparison of graha strength | `dep.shadbala-arithmetic` | — | 26 | +2 | 496 |
| 9 | `dep.universal-quantification` — universal quantification over a variable-membership set | — | — | 15 | +1 | 497 |
| 10 | `dep.manual-verification` — human verification of the encoding | — | — | 20 | +1 | 498 |
| 11 | `dep.body-part-significator` — house-to-body-part correspondence | — | — | 2 | +1 | 499 |
| 12 | `dep.ashtakavarga` — ashtakavarga | — | ch. 23 | 24 | +1 | 500 |

Completing this sequence costs **143 units** and moves executable cards from **484** to **500** — releasing **16 of the 17** currently blocked cards.
...
Across the 21 unencoded chapters that is roughly **1009 cards**, of which about **325 (32%) would be inert on arrival** if they were encoded before the missing capabilities exist.
