...
The store holds **400** cards, of which **380** are executable and **20** are recorded but blocked. This document ranks what to build next by how much of that blocked knowledge each capability releases.
...
|---:|---|---|---|---:|---:|---:|
| 1 | `dep.vargottama` — vargottama extractor | `dep.varga` | ch. 03 | 14 | +3 | 383 |
| 2 | `dep.strength` — planetary and house strength (Stage 4) | — | ch. 04 | 34 | +7 | 390 |
| 3 | `dep.second-nativity` — a second nativity | — | — | 5 | +1 | 391 |
| 4 | `dep.transit` — transit (gochara) calculation | — | — | 6 | +1 | 392 |
| 5 | `dep.dasa` — vimshottari dasa engine | — | ch. 19 | 16 | +3 | 395 |
| 6 | `dep.prashna` — prashna (horary) branch | — | — | 6 | +1 | 396 |
| 7 | `dep.adjudication` — Stage 7 adjudication | — | — | 8 | +1 | 397 |
| 8 | `dep.universal-quantification` — universal quantification over a variable-membership set | — | — | 15 | +1 | 398 |
| 9 | `dep.manual-verification` — human verification of the encoding | — | — | 20 | +1 | 399 |
| 10 | `dep.ashtakavarga` — ashtakavarga | — | ch. 23 | 25 | +1 | 400 |

Completing this sequence costs **149 units** and moves executable cards from **380** to **400** — releasing **20 of the 20** currently blocked cards.
...
Across the 22 unencoded chapters that is roughly **1120 cards**, of which about **422 (38%) would be inert on arrival** if they were encoded before the missing capabilities exist.
