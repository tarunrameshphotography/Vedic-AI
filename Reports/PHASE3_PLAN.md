...
The store holds **379** cards, of which **359** are executable and **20** are recorded but blocked. This document ranks what to build next by how much of that blocked knowledge each capability releases.
...
| `dep.strength` — planetary and house strength (Stage 4) | calculator | 8 | 10 | 7 | 7 | 39 | 0.18 |
...
| `dep.ashtakavarga` — ashtakavarga | calculator | 1 | 2 | 0 | 0 | 24 | 0.00 |
...
|---:|---|---|---|---:|---:|---:|
| 1 | `dep.vargottama` — vargottama extractor | `dep.varga` | ch. 03 | 13 | +3 | 362 |
| 2 | `dep.strength` — planetary and house strength (Stage 4) | — | ch. 04 | 33 | +7 | 369 |
| 3 | `dep.second-nativity` — a second nativity | — | — | 5 | +1 | 370 |
| 4 | `dep.transit` — transit (gochara) calculation | — | — | 6 | +1 | 371 |
| 5 | `dep.dasa` — vimshottari dasa engine | — | ch. 19 | 15 | +3 | 374 |
| 6 | `dep.prashna` — prashna (horary) branch | — | — | 6 | +1 | 375 |
| 7 | `dep.adjudication` — Stage 7 adjudication | — | — | 8 | +1 | 376 |
| 8 | `dep.universal-quantification` — universal quantification over a variable-membership set | — | — | 15 | +1 | 377 |
| 9 | `dep.manual-verification` — human verification of the encoding | — | — | 20 | +1 | 378 |
| 10 | `dep.ashtakavarga` — ashtakavarga | — | ch. 23 | 24 | +1 | 379 |

Completing this sequence costs **145 units** and moves executable cards from **359** to **379** — releasing **20 of the 20** currently blocked cards.
...
Across the 22 unencoded chapters that is roughly **1059 cards**, of which about **400 (38%) would be inert on arrival** if they were encoded before the missing capabilities exist.
