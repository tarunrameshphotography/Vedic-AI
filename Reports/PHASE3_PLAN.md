...
The store holds **344** cards, of which **322** are executable and **22** are recorded but blocked. This document ranks what to build next by how much of that blocked knowledge each capability releases.
...
|---:|---|---|---|---:|---:|---:|
| 1 | `dep.dignity-friendship` — natural friendship (the unresolved half of dignity) | `dep.manual-verification` | — | 21 | +5 | 327 |
| 2 | `dep.second-nativity` — a second nativity | — | — | 5 | +1 | 328 |
...
Completing this sequence costs **161 units** and moves executable cards from **322** to **344** — releasing **22 of the 22** currently blocked cards.
