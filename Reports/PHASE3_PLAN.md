...
The store holds **381** cards, of which **361** are executable and **20** are recorded but blocked. This document ranks what to build next by how much of that blocked knowledge each capability releases.
...
| `dep.strength` — planetary and house strength (Stage 4) | calculator | 8 | 11 | 7 | 7 | 39 | 0.18 |
| `dep.varga` — varga (divisional chart) engine | calculator | 5 | 6 | 2 | 2 | 12 | 0.17 |
...
| `dep.manual-verification` — human verification of the encoding | process | 1 | 6 | 1 | 1 | 20 | 0.05 |
| `dep.ashtakavarga` — ashtakavarga | calculator | 1 | 3 | 0 | 0 | 24 | 0.00 |
...
|---:|---|---|---|---:|---:|---:|
| 1 | `dep.vargottama` — vargottama extractor | `dep.varga` | ch. 03 | 13 | +3 | 364 |
| 2 | `dep.strength` — planetary and house strength (Stage 4) | — | ch. 04 | 33 | +7 | 371 |
| 3 | `dep.second-nativity` — a second nativity | — | — | 5 | +1 | 372 |
| 4 | `dep.transit` — transit (gochara) calculation | — | — | 6 | +1 | 373 |
| 5 | `dep.dasa` — vimshottari dasa engine | — | ch. 19 | 15 | +3 | 376 |
| 6 | `dep.prashna` — prashna (horary) branch | — | — | 6 | +1 | 377 |
| 7 | `dep.adjudication` — Stage 7 adjudication | — | — | 8 | +1 | 378 |
| 8 | `dep.universal-quantification` — universal quantification over a variable-membership set | — | — | 15 | +1 | 379 |
| 9 | `dep.manual-verification` — human verification of the encoding | — | — | 20 | +1 | 380 |
| 10 | `dep.ashtakavarga` — ashtakavarga | — | ch. 23 | 24 | +1 | 381 |

Completing this sequence costs **145 units** and moves executable cards from **361** to **381** — releasing **20 of the 20** currently blocked cards.
...
Across the 22 unencoded chapters that is roughly **1068 cards**, of which about **402 (38%) would be inert on arrival** if they were encoded before the missing capabilities exist.
