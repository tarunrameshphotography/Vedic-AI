...
The store holds **404** cards, of which **384** are executable and **20** are recorded but blocked. This document ranks what to build next by how much of that blocked knowledge each capability releases.
...
| `dep.strength` — planetary and house strength (Stage 4) | calculator | 8 | 11 | 7 | 7 | 41 | 0.17 |
...
|---:|---|---|---|---:|---:|---:|
| 1 | `dep.vargottama` — vargottama extractor | `dep.varga` | ch. 03 | 14 | +3 | 387 |
| 2 | `dep.strength` — planetary and house strength (Stage 4) | — | ch. 04 | 35 | +7 | 394 |
| 3 | `dep.second-nativity` — a second nativity | — | — | 5 | +1 | 395 |
| 4 | `dep.transit` — transit (gochara) calculation | — | — | 6 | +1 | 396 |
| 5 | `dep.dasa` — vimshottari dasa engine | — | ch. 19 | 16 | +3 | 399 |
| 6 | `dep.prashna` — prashna (horary) branch | — | — | 6 | +1 | 400 |
| 7 | `dep.adjudication` — Stage 7 adjudication | — | — | 8 | +1 | 401 |
| 8 | `dep.universal-quantification` — universal quantification over a variable-membership set | — | — | 15 | +1 | 402 |
| 9 | `dep.manual-verification` — human verification of the encoding | — | — | 20 | +1 | 403 |
| 10 | `dep.ashtakavarga` — ashtakavarga | — | ch. 23 | 25 | +1 | 404 |

Completing this sequence costs **150 units** and moves executable cards from **384** to **404** — releasing **20 of the 20** currently blocked cards.
...
Across the 22 unencoded chapters that is roughly **1131 cards**, of which about **426 (38%) would be inert on arrival** if they were encoded before the missing capabilities exist.
