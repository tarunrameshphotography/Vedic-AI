...
The store holds **344** cards, of which **320** are executable and **24** are recorded but blocked. This document ranks what to build next by how much of that blocked knowledge each capability releases.
...
| `dep.dignity-friendship` — natural friendship (the unresolved half of dignity) | reference | 5 | 5 | 3 | 5 | 21 | 0.24 |
| `dep.second-nativity` — a second nativity | schema | 1 | 2 | 1 | 1 | 5 | 0.20 |
| `dep.dignity-override` — dignity-override mechanism | schema | 2 | 2 | 1 | 1 | 6 | 0.17 |
...
|---:|---|---|---|---:|---:|---:|
| 1 | `dep.dignity-override` — dignity-override mechanism | — | — | 3 | +1 | 321 |
| 2 | `dep.rule-transfer` — rule-transfer mechanism | — | — | 3 | +1 | 322 |
| 3 | `dep.dignity-friendship` — natural friendship (the unresolved half of dignity) | `dep.manual-verification` | — | 21 | +5 | 327 |
| 4 | `dep.second-nativity` — a second nativity | — | — | 5 | +1 | 328 |
| 5 | `dep.vargottama` — vargottama extractor | `dep.varga` | ch. 03 | 18 | +3 | 331 |
| 6 | `dep.transit` — transit (gochara) calculation | — | — | 6 | +1 | 332 |
| 7 | `dep.prashna` — prashna (horary) branch | — | — | 6 | +1 | 333 |
| 8 | `dep.strength` — planetary and house strength (Stage 4) | — | ch. 04 | 45 | +6 | 339 |
| 9 | `dep.dasa` — vimshottari dasa engine | — | ch. 19 | 20 | +3 | 342 |
| 10 | `dep.adjudication` — Stage 7 adjudication | — | — | 8 | +1 | 343 |
| 11 | `dep.ashtakavarga` — ashtakavarga | — | ch. 23 | 32 | +1 | 344 |

Completing this sequence costs **167 units** and moves executable cards from **320** to **344** — releasing **24 of the 24** currently blocked cards.
...
20 card(s) remain blocked after every step above, because they depend on capabilities with no path that pays for itself yet:
